...
slowdown to $37\times$.
\add{As shown in Figure~\ref{fig:performance_parsing}, the log aggregation time is linearly correlated with the log trace size (F-score=68, p-value $\leq 10^{-8}$, obtained with the F-test for linear regression).}
