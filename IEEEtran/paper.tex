...
green \valid\xspace for success and red \cross\xspace for error. Tracing errors
...
measured the result precision in significant bits on the final primary example output
...
and could therefore be computed even when parsing failed. We use the term ``result precision"
...
\add{This example shows that \pytracer workds on 2D inputs and the importance of
...
\pytracer allows us to quickly visualize the new result precision.
...
$3.5\times$. Finally, \remove{the Fuzzy instrumentation} using MCA
